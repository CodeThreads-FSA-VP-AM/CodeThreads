...
const MaleProducts = ({ setProductId, user, setSuccess, setSuccessMsg, setSuccessTitle, }) => {
    var _a;
    ...
    (0, react_1.useEffect)(() => {
        const loadProducts = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const mensProducts = allProducts.filter((product) => product.tags.some((tag) => tag.name === "mens"));
