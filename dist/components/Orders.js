...
const Orders = ({ setProductsLength, wishlist, setWishlist, setSuccess, setSuccessMsg, setSuccessTitle, orders, setOrders, }) => {
    ...
    const handleDeleteOrder = (product_id) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const updatedOrders = yield (0, api_1.fetchOrder)(userId);
            const addedOrders = updatedOrders.filter((o) => o.status === "added");
