        ...
        <div className='relative'>
          ...
          <div id='md-searchbar' className={`${mdOptionsToggle ? 'hidden' : 'flex'} lg:hidden py-5 px-6 items-center justify-between`}>
            ...
            <div className='space-x-6'>
              ...
              <button aria-label='go to cart' className='text-gray-800 dark:text-black focus:outline-none focus:ring-2 focus:ring-gray-800'>
          ...
          <div className='px-6 bg-white py-9'>
            <div className='container flex items-center justify-between mx-auto'>
              <h1 className='text-2xl text-gray-800 cursor-pointer md:w-2/12 dark:text-black' aria-label='code Threads.'>
                codeThreads
              </h1>
                      ...
                      <div className='flex items-center'>
                        ...
                        >
                          ...
                          {user.avatar_url === null ? (
                            ...
                            <img className='object-cover w-12 h-12 rounded-full' src={user.avatar_url} alt='default' />
                          )}
                          <p className='text-gray-800 text-sm ml-2'>{user.username}</p>
                        </div>
                      </div>
                    </>
                  )}
          ...
          <div
            id='mobile-menu'
            className={`${showMenu ? 'flex' : 'hidden'} absolute dark:bg-white z-10 inset-0 md:hidden bg-black flex-col h-screen w-full`}
          >
