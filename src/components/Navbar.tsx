              ...
              <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                ...
                <div className="flex lg:hidden">
                  <button
                    ...
                    className="text-black dark:text-black dark:hover:text-gray-300 hidden md:flex focus:outline-none focus:ring-2 rounded focus:ring-gray-600"
                  >
                    <svg
                      className="fill-stroke"
                      width={24}
                  ...
                  <button
                    ...
                    className="text-black dark:text-black dark:hover:text-gray-300 md:hidden focus:outline-none focus:ring-2 rounded focus:ring-gray-600"
                  >
                    <svg
                      className="fill-stroke"
                      width={24}
