...
const Footer: React.FC = () => {
  return (
    <>
      <div className="container z-50 grid items-center justify-center px-4 pt-16 pb-2 mx-auto xl:px-20 lg:px-12 sm:px-6">
        <div className="grid items-center justify-center grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8">
        ...
        <div className="pt-6">
          <ul className="flex flex-wrap justify-start gap-4 text-xs lg:justify-center">
            <li>
              <p className="text-gray-500 transition cursor-pointer hover:opacity-75">
                Terms & Conditions
              </p>
            </li>
