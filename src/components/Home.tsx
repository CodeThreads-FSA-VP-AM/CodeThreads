    ...
    <section className="px-4 mx-auto max-w-screen-2xl md:px-8">
      <div className="flex flex-wrap justify-between mb-8 md:mb-16">
        <div className="flex flex-col justify-center w-full mb-6 lg:w-1/3 lg:pt-48 lg:pb-24 sm:mb-12 lg:mb-0">
          ...
          <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium excepturi natus architecto aspernatur neque voluptatem debitis qui
            facilis deserunt, unde illum dignissimos eligendi fugiat ut suscipit possimus alias, exercitationem dolorum!
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
        ...
        <div className="flex items-center justify-center gap-4 lg:justify-start">
          <span className="text-sm font-semibold tracking-widest text-gray-400 uppercase sm:text-base">Social</span>
