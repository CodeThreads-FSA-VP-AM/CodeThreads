...
import { fetchOrder, deleteOrder, fetchUser, checkoutOrder, fetchProductById } from "../api/api";
...
const Orders: React.FC<Props> = ({
  ...
  const handleDeleteOrder = async (product_id: number) => {
    try {
      ...
      const addedOrders = updatedOrders.filter((o: { status: string }) => o.status === "added");
