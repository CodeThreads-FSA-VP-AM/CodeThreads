      ...
      {loading ? (
        ...
        <section>
                ...
                <div className='flex justify-between mt-8'>
                  <div className='max-w-[35ch] space-y-2'>
                    ...
                    <div className='-ml-0.5 flex'>
                      ...
                      <button className='ml-2 text-xs text-blue-400 underline'>Add Review</button>
                    </div>
                  </div>
          ...
          <div>
            ...
            <AddReview token={token} product_id={productId} reviews={reviews} setReviews={setReviews} user={user.username} />
          </div>
        </section>
      )}
    </>
