        ...
        <section className="py-24">
          <div className="container px-4 mx-auto">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <h3 className="mb-5 text-2xl font-black">Your order has been placed</h3>
              <p className="mb-12 text-lg font-bold">
                Congratulations! Your order has been successfully placed. We'll keep you updated on
                the shipping status and provide tracking information once your package is on its
                way.
              </p>
              <Link
                to="/products"
